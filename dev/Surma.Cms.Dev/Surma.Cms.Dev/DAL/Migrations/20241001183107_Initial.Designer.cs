...
namespace Surma.Cms.Dev.DAL.Migrations
{
    ...
    [Migration("20241001183107_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Surma.Cms.Core.Pages.Page", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Surma.Cms.Core.Pages.Page", b =>
                {
                    b.HasOne("Surma.Cms.Core.Assets.Asset", "ContentAsset")
                        .WithMany()
                        .HasForeignKey("ContentAssetId");

                    b.Navigation("ContentAsset");
                });
